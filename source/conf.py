# -*- coding: utf-8 -*-
#
# GeoNetwork opensource documentation build configuration file, created by
# sphinx-quickstart on Mon Apr 20 11:23:54 2015.
#
...
copyright = u'2001-{}, GeoNetwork opensource. ' \
            u'Licensed under Creative Commons Attribution ShareAlike (Unported) v3.0 License'.format(now.year)
author = u''
...
htmlhelp_basename = 'GeoNetworkopensourcedoc'
...
latex_documents = [
    (master_doc, 'GeoNetworkopensource.tex', u'GeoNetwork opensource Documentation',
     u'Authors', 'manual'),
]
