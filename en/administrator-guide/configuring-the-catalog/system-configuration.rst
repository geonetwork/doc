...
To see the System configuration parameters, you must be logged on as administrator. Open the Administration page and select "Settings".
...
Since the settings form is a long form, the 'save' button is repeated between the sections.
